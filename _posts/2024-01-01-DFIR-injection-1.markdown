...
header:
  teaser: "/blog/assets/images/5/2024-01-02_13-37.png"
categories: 
  - forensics
tags:
  - blueteam
...
![mem](/blog/assets/images/5/2024-01-02_13-37.png){:class="img-responsive"}    

Today we will show in practice how to detect process injection via memory forensics. 

First of all, let's say we have a malware [sample](/blog/assets/images/5/hack.exe.7z). For simulating process injection, just execute `notepad.exe` and run it in the victim's machine (Windows 7 x64 VM in my case):    

```powershell
.\hack.exe <notepad.exe PID>
```

![mem](/blog/assets/images/5/2024-01-02_11-04.png){:class="img-responsive"}    
...
![mem](/blog/assets/images/5/2024-01-02_11-16.png){:class="img-responsive"}    

![mem](/blog/assets/images/5/2024-01-02_11-15.png){:class="img-responsive"}    
...
![mem](/blog/assets/images/5/2024-01-02_11-16_1.png){:class="img-responsive"}        

![mem](/blog/assets/images/5/2024-01-02_11-18.png){:class="img-responsive"}        
...
![mem](/blog/assets/images/5/2024-01-02_11-19.png){:class="img-responsive"}        
...
![mem](/blog/assets/images/5/2024-01-02_11-20.png){:class="img-responsive"}        
...
![mem](/blog/assets/images/5/2024-01-03_11-22.png){:class="img-responsive"}        
...
![mem](/blog/assets/images/5/2024-01-02_11-19_1.png)    
...
![mem](/blog/assets/images/5/2024-01-02_12-02.png){:class="img-responsive"}        

Finally, if we search our bytes `fc 48 81 e4`:    

![mem](/blog/assets/images/5/2024-01-02_12-40.png){:class="img-responsive"}        
